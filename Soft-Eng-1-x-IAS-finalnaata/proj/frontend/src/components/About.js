    ...
    <>
      ...
      <div className="about-story">
        ...
        <p>
          ...
          buds were mostly harvested during St. John’s Feast Day every 24th June,
          making the plant to have more healing and magical powers more
          effective when harvested on the said date.
        </p>
        <p>
          Additionally, St. John from the name of the website was an answer or
          a continuation of the project of 2 out of 4 members of the team. These 
          people are{" "}
          <i>
          ...
          named <b>St. John’s Hospital</b>, a reservation-type application made from
      ...
      <div className="about-teamhead">
        ...
        <div className="about-team">
          <div className="team-container">
            <div className="team-pic">
              <img src="/images/clydepic.jpg" alt="" />
            </div>
            <div className="team-info">
              <h3> Clyde Denzel Asgar </h3>
              <p>
                {/* <br /> */}
                Researcher <br />
                Documentarist
